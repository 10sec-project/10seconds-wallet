...
public abstract class InputParser {
    ...
    public abstract static class StringInputParser extends InputParser {
        ...
        public void parse() {
            ...
            } else if (input.startsWith("10seconds:") || input.startsWith("10SECONDS:")) {
                try {
                    final BitcoinURI bitcoinUri = new BitcoinURI(null, "10seconds:" + input.substring(8));
                    ...
                    log.info("got invalid 10seconds uri: '" + input + "'", x);
